(* order alfa alfas Higgs version of MSSMCT.mod *)
...
htInsert[c_] :=
Block[ {cy, mtmw},
  cy = mtmw^2 Coefficient[c MW^2/MT^2 /. MB -> 0 /. MB2 -> 0, MW, 0];
  cy += mtmw Coefficient[(c - cy /. mtmw -> MT/MW) MW/MT /. MB -> 0 /. MB2 -> 0, MW, 0];
  cy += c - cy /. mtmw -> MT/MW;
