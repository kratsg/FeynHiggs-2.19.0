...
(* reductions for T11234, T11m23m4' and T11m23'4m added by SP *)

T[Df[k1, m1_]^2 Df[k2, m2_] Df[k3, m3_] Df[k4, m4_]] :=      (* T11234 *)
(2 - $D) T[Df[k1, m1] Df[k2, m2] Df[k3, m3] Df[k4, m4]]/(2 m1^2) + (m4^2 (m1^2 + m3^2 - m4^2) ((2 - $D) b0[0, 0, m4] b0[p2, m1, m2] + 2 T[Df[k2, m4]^2 Df[k3, m3] Df[k4, m2]]) + m3^2 (m1^2 - m3^2 + m4^2) ((2 - $D) b0[0, 0, m3] b0[p2, m1, m2] + 2 T[Df[k2, m3]^2 Df[k3, m4] Df[k4, m2]]) + 2 m1^2 (m1^2 - m3^2 - m4^2) (-3 + $D) T[Df[k1, m1] Df[k2, m2] Df[k3, m3] Df[k4, m4]])/(2 m1^2 (m1^4 + m3^4 + m4^4 - 2 (m1^2 m3^2 + m1^2 m4^2 + m3^2 m4^2))) + (-1/(2 m1^2) (m1^2 + m2^2 - p2) ((-2 + $D) T[Df[k1, m4] Df[k3, m3] Df[k4, m1]] + (8 - 3 $D) T[Df[k2, m4] Df[k3, m3] Df[k4, m2]] + 2 m4^2 T[Df[k2, m4]^2 Df[k3, m3] Df[k4, m2]] + 2 m3^2 T[Df[k2, m3]^2 Df[k3, m4] Df[k4, m2]]) + (2 m2^2 (-m2^2 + p2) T[Df[k2, m2]^2 Df[k3, m4] Df[k4, m3]])/m1^2 + (m1^2 - m2^2 - p2) (-3 + $D) T[Df[k1, m1] Df[k2, m2] Df[k3, m3] Df[k4, m4]])/(m1^4 + m2^4 + p2^2 - 2 (m1^2 m2^2 + m1^2 p2 + m2^2 p2)) /; m1 =!= 0 && !(m3 === 0 && m4 === m1) && !(m4 === 0 && m3 === m1);

T[Df[k1, m1_]^2 Df[k2, m2_] Df[k3, m1_] Df[k4, 0]] :=      (* T11m23m4' *)
  (-2 + $D) b0[0, 0, m1] ((-2 + $D) (-(m1^2 + m2^2 - p2) b0[0, 0, m1] + 2 m2^2 b0[0, 0, m2])/(-3 + $D) + 2 (m1^2 - m2^2 - p2) b0[p2, m1, m2])/(4 (m1^4 + m2^4 + p2^2 - 2 (m1^2 m2^2 + m1^2 p2 + m2^2 p2))) - 1/(4 m1^2 (-3 + $D)) ((-2 + $D) b0[0, 0, m1] b0[p2, m1, m2] - 2 T[Df[k2, m1]^2 Df[k3, m2] Df[k4, 0]] + 2 T[Df[k2, 0]^2 Df[k3, m2] Df[k4, m1]]) /; m1 =!= 0;

T[Df[k1, m1_]^2 Df[k2, m2_] Df[k3, 0] Df[k4, m1_]] :=      (* T11m23'4m *)
T[Df[k1, m1]^2 Df[k2, m2] Df[k3, m1] Df[k4, 0]] /; m1 =!= 0;

(* reductions for T1'234, T1'1'234, T1'1'1'234 and T1'1'1'1'234 added by SP *)
  
T[Df[k1, 0] Df[k2, m1_] Df[k3, m2_] Df[k4, m3_]] :=         (* T1'234 *)
1/(-2 + dim) (1/(m2^2 - m3^2) ((-2 + dim) (m2^2 b0[0, 0, m2] - m3^2 b0[0, 0, m3]) b0[p2, 0, m1] + 2 m3^2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] - 2 m2^2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]]) + (1/(m1^2 - p2)) (-(-2 + dim) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]] + (-8 + 3 dim) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] - 2 (m3^2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + m2^2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] + 2 m1^2 T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]]))) /; m2 =!= m3;

T[Df[k1, 0] Df[k2, m1_] Df[k3, m2_] Df[k4, m2_]] :=         (* T1'23m4m *)
1/2 (-2 + dim) b0[0, 0, m2] b0[p2, 0, m1] - T[Df[k2, m2]^2 Df[k3, m2] Df[k4, m1]] + (1/(m1^2 - p2))(-((m2^2 (-2 + dim)^2 b0[0, 0, m2]^2)/(2 (-3 + dim))) + (-8 + 3 dim) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]] - 4 (m2^2 T[Df[k2, m2]^2 Df[k3, m2] Df[k4, m1]] + m1^2 T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]])) /; m2 =!= 0;

T[Df[k1, 0]^2 Df[k2, m1_] Df[k3, m2_] Df[k4, m3_]] :=       (* T1'1'234 *)
((-m1^2 + p2)^2 (m3^2 (3 m2^2 + m3^2) (-(-2 + dim) b0[0, 0, m3] b0[p2, 0, m1] + 2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]]) + m2^2 (m2^2 + 3 m3^2) ((-2 + dim) b0[0, 0, m2] b0[p2, 0, m1] - 2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]])) + (m2^2 - m3^2)^2 ((-2 + dim) (m2^2 b0[0, 0, m2] - m3^2 b0[0, 0, m3]) ((-2 + dim) m1^2 b0[0, 0, m1] - (-1 + dim) (m1^2 + p2) b0[p2, 0, m1]) - 4 m3^2 (m1^2 + p2) T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + 4 m2^2 (m1^2 + p2) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]]) - (m2^2 - m3^2)^3 ((-2 + dim) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]] + (8 - 3 dim) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] + 2 m3^2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + 2 m2^2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] - 2 (m1^2 + p2) T[Df[k1, 0] Df[k2, m1] Df[k3, m2] Df[k4, m3]]) + (m2^2 - m3^2) (-m1^2 + p2) ((-2 + dim)^2 m2^2 m3^2 b0[0, 0, m2] b0[0, 0, m3] - (-3 + dim) (m2^2 + m3^2) ((-2 + dim) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]] + 2 (-m1^2 + p2) T[Df[k1, 0] Df[k2, m1] Df[k3, m2] Df[k4, m3]])))/(dim (m2^2 - m3^2)^3 (-m1^2 + p2)^2) /; m2 =!= m3;

T[Df[k1, 0]^2 Df[k2, m1_] Df[k3, m2_] Df[k4, m2_]] :=       (* T1'1'23m4m *)
(1/(24 (m1^2 - p2)^3)) (1/(15 - 8 dim + dim^2) (-2 + dim)^2 (m1^4 (-7 + dim) (-3 + dim) + 2 m1^2 (-p2 (-7 + dim) (-3 + dim) + 2 m2^2 (-5 + dim) (-9 + 2 dim)) + p2 (p2 (-7 + dim) (-3 + dim) + 4 m2^2 (-5 + dim) (-7 + 2 dim))) b0[0, 0, m2]^2 + (m1^2 - p2) (-2 + dim) b0[0, 0, m2] (4 m1^2 (-2 + dim) b0[0, 0, m1] - (((m1^2 - p2)^2 (-4 + dim) + 12 m2^2 (m1^2 + p2) (-3 + dim)) b0[p2, 0, m1])/m2^2) + 1/m2^2 (-2 (-8 + 3 dim) (m1^4 (-3 + dim) + m1^2 (-2 p2 (-3 + dim) + 4 m2^2 (-9 + 2 dim)) + p2 (p2 (-3 + dim) + 4 m2^2 (-7 + 2 dim))) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]] - 2 (16 m1^2 m2^4 (9 - 2 dim) - (m1^6 - 3 m1^4 p2 + 3 m1^2 p2^2) (-4 + dim) + 4 m1^2 m2^2 (-3 m1^2 + 2 p2) (-3 + dim) + p2 (-4 m2^2 + p2) (p2 (-4 + dim) + 4 m2^2 (-7 + 2 dim))) T[Df[k2, m2]^2 Df[k3, m2] Df[k4, m1]] + 8 m1^2 (8 m2^2 (m1^2 + p2) (-4 + dim) + (m1^2 - p2)^2 (-3 + dim)) T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]])) /; m2 =!= 0;

T[Df[k1, 0]^2 Df[k2, m1_] Df[k3, 0] Df[k4, 0]] :=          (* T1'1'23'4' *)
(1/((m1^2 - p2)^2 (-6 + dim)))((8 - 3 dim) T[Df[k2, m1] Df[k3, 0] Df[k4, 0]] + 2 (m1^2 + p2) (-7 + 2 dim) T[Df[k1, 0] Df[k2, m1] Df[k3, 0] Df[k4, 0]]);

T[Df[k1, 0]^3 Df[k2, m1_] Df[k3, m2_] Df[k4, m3_]] :=      (* T1'1'1'234 *)
 ((-2 + $D)^2 (m2^2 m3^2 (-(m2^2 + m3^2) (-m1^2 + p2)^3 (-4 + $D) (3 + $D) + 2 (m2^2 - m3^2)^2 (-m1^2 + p2) (-p2 (-6 + $D) + m1^2 (6 + $D))) b0[0, 0, m2] b0[0, 0, m3] + m1^2 (m2^2 - m3^2) b0[0, 0, m1] (-m2^2 (2 m1^4 (m2^2 (-6 + $D) - m3^2 (6 + $D)) + m1^2 ((m2^4 + m3^4) (-4 + $D) (3 + $D) + 4 m3^2 p2 (6 + $D) + m2^2 (-4 p2 (-6 + $D) - 2 m3^2 (-4 + $D) (3 + $D))) + p2 ((m2^4 + m3^4) (-4 + $D) (3 + $D) - 2 m3^2 p2 (6 + $D) + 2 m2^2 (p2 (-6 + $D) - m3^2 (-4 + $D) (3 + $D)))) b0[0, 0, m2] + m3^2 (-2 m1^4 (-m3^2 (-6 + $D) + m2^2 (6 + $D)) + p2 (2 m3^2 p2 (-6 + $D) + (m2^4 + m3^4) (-4 + $D) (3 + $D) - 2 m2^2 (m3^2 (-4 + $D) (3 + $D) + p2 (6 + $D))) + m1^2 (-4 m3^2 p2 (-6 + $D) + (m2^4 + m3^4) (-4 + $D) (3 + $D) + m2^2 (-2 m3^2 (-4 + $D) (3 + $D) + 4 p2 (6 + $D)))) b0[0, 0, m3])))/(2 (m2^2 - m3^2)^4 (-m1^2 + p2)^4 $D (2 + $D)) - (m2^4 m3^2 b0[0, 0, m3] b0[p2, 0, m1])/(m2^2 - m3^2)^5 + (m3^4 (-6 + $D) (-m3^2 (-4 + $D) + 2 m2^2 (2 + $D)) b0[0, 0, m3] b0[p2, 0, m1])/((m2^2 - m3^2)^5 $D (2 + $D)) + ((m1^4 + (p2 (-6 + $D) (-2 m1^2 + p2 - (6 p2)/(2 + $D)))/$D) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]])/(-m1^2 + p2)^5 + ((-3 + $D) ((m2^2 - m3^2) (-m1^2 + p2) (m2^2 (2 m1^2 (m2^2 - m3^2)^2 p2 (-6 + $D) $D + 2 m1^2 (-m1^2 + p2) (m1^2 + p2) (-m2^2 (-4 + $D) + m3^2 $D) + p2^2 (-2 m3^2 p2 $D + (m2^4 + m3^4) (-4 + $D) $D + 2 m2^2 (-4 + $D) (p2 - m3^2 $D)) + m1^4 (2 m3^2 p2 $D + (m2^4 + m3^4) (-4 + $D) $D - 2 m2^2 (-4 + $D) (p2 + m3^2 $D))) b0[0, 0, m2] + m3^2 (-(m2^2 - m3^2)^2 (2 m1^2 p2 (-6 + $D) + (m1^4 + p2^2) (-4 + $D)) $D + 2 (m1^2 + p2) (4 m3^2 (-m1^2 + p2)^2 + (m2^2 - m3^2) (m1^2 - p2)^2 $D)) b0[0, 0, m3]) b0[p2, 0, m1] + (2 m1^2 (m2^6 + m3^6) p2^2 (8 - 3 $D) + (m2^4 + m3^4) (-m1^2 + p2)^4 (-4 + $D) $D + 2 (m2^2 - m3^2)^2 (m2^2 + m3^2) (p2^3 (-4 + $D) - m1^6 $D + m1^4 p2 (-4 + 3 $D)) - 2 m2^2 m3^2 (-(m1^8 - 4 m1^6 p2 + 6 m1^4 p2^2 + p2^4) (-6 + $D) $D + m1^2 p2^2 ((m2^2 + m3^2) (8 - 3 $D) + 4 p2 (-6 + $D) $D))) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]]))/(2 (m2^2 - m3^2)^4 (-m1^2 + p2)^5 $D) + (m3^2 (-m1^2 + p2)^3 (48 (m1^4 m3^2 (m2^2 + m3^2) - 2 m1^2 m3^2 (m2^4 - 2 m3^4 + m3^2 p2 + m2^2 (m3^2 + p2)) + p2 (3 m2^6 + m2^2 m3^2 (m2^2 - 5 m3^2 + p2) + m3^4 (m3^2 + p2))) + 4 (m2^2 - m3^2) (m1^4 (m2^2 + 5 m3^2) - 2 m1^2 (-14 m3^4 + 5 m3^2 p2 + m2^2 (2 m3^2 + p2)) + p2 (-18 m2^4 + m2^2 (-16 m3^2 + p2) + 5 m3^2 (2 m3^2 + p2))) $D + 2 (m2^2 - m3^2)^2 (m1^4 + m1^2 (8 m3^2 - 2 p2) + p2 (4 (m2^2 + m3^2) + p2)) $D^2) T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + m2^2 (-m1^2 + p2)^5 (m2^4 (-6 + $D) (-4 + $D) - 2 m2^2 m3^2 (-6 + $D) (2 + $D) + m3^4 $D (2 + $D)) ((-2 + $D) b0[0, 0, m2] b0[p2, 0, m1] - 2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]]) - (m2^2 - m3^2)^5 (p2^2 (-6 + $D) (-4 + $D) - 2 m1^2 p2 (-6 + $D) (2 + $D) + m1^4 $D (2 + $D)) ((-8 + 3 $D) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] - 2 (m3^2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + m2^2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]])) + 4 m1^2 (m2^2 - m3^2)^5 (12 (m1^2 + p2)^2 + (-m1^2 + p2)^2 (-4 + $D) $D) T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]] - 2 (m2^2 - m3^2) (-m1^2 + p2) (3 - $D) (4 m2^2 (p2^2 (-4 m2^4 m3^2 + m2^2 (-8 m3^2 p2 + m3^4 (14 - 3 $D)) + m3^4 p2 (-6 + $D) + 2 m3^6 (-4 + $D) + (m2^6 - m2^4 p2) (-2 + $D)) + m1^6 (-2 m2^4 (-4 + $D) + 2 m2^2 m3^2 (2 + $D)) + m1^4 p2 (m3^4 (-6 + $D) - 4 m2^2 m3^2 (4 + $D) + m2^4 (-14 + 3 $D)) + 2 m1^2 p2 (4 m2^6 - m3^4 (p2 (-6 + $D) + m3^2 (2 + $D)) - m2^4 (-2 p2 + m3^2 (10 + $D)) + m2^2 (2 m3^4 (4 + $D) + m3^2 p2 (10 + $D)))) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] + 6 (m2^2 + m3^2)^2 (-m1^2 + p2)^3 ((-8 + 3 $D) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] - 4 m1^2 T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]]) + (m2^2 - m3^2)^2 (4 m3^2 (p2^2 (2 m2^2 (-4 + $D) + m3^2 (-2 + $D)) - m1^4 m3^2 (-6 + $D) - 2 m1^2 p2 (-4 m3^2 + m2^2 (2 + $D))) T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] - 4 m1^4 m2^4 (-6 + $D) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] + (-m1^2 + p2)^3 $D ((8 - 3 $D) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] + 4 m1^2 T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]]) - (m2^2 + m3^2) (-m1^2 + p2) ((-8 + 3 $D) (m1^2 (-6 + $D) + p2 (-10 + 3 $D)) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] - 8 m1^2 (m1^2 + p2) (-4 + $D) T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]]))))/((m2^2 - m3^2)^5 (-m1^2 + p2)^5 $D (-4 + $D^2)) /; m2 =!= m3;

T[Df[k1, 0]^3 Df[k2, m1_] Df[k3, m2_] Df[k4, m2_]] :=    (* T1'1'1'23m4m *)
1/480 (((-6 + dim) (-4 + dim) (-2 + dim) b0[0, 0, m2] b0[p2, 0, m1])/m2^4 + (1/(m2^2 (-m1^2 + p2)^4))  4 (-2 + dim) b0[0, 0, m2] (-(-2 + dim) m1^2 ((-6 + dim) m1^4 + 2 m1^2 ((-27 + 7 dim) m2^2 - (-6 + dim) p2) + p2 (2 (-27 + 7 dim) m2^2 + (-6 + dim) p2)) b0[0, 0, m1] + 5 (-3 + dim) (12 (-6 + dim) m1^2 m2^2 p2 + (-4 + dim) (m1^6 + m1^4 (6 m2^2 - p2) + 6 m2^2 p2^2)) b0[p2, 0, m1]) - (2 (-6 + dim) (-3 + dim) (-8 + 3 dim) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]])/(m2^4 (-m1^2 + p2)) + (1/(m2^2 (-m1^2 + p2)^3)) 480 (-3 + dim) (1/24 (-4 + dim) (-2 + dim) p2^2 b0[0, 0, m2] b0[p2, 0, m1] - 1/60 (-8 + 3 dim) ((-15 + 4 dim) m1^2 + (-13 + 4 dim) p2) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]]) + (1/((-m1^2 + p2)^5))((1/(-3 + dim)) 16 ((87 + 4 (-9 + dim) dim) m1^4 + 2 (117 - 46 dim + 4 dim^2) m1^2 p2 + (-9 + 2 dim) (-7 + 2 dim) p2^2) ((-2 + dim)^2 m2^2 b0[0, 0, m2]^2 - 2 (-3 + dim) (-8 + 3 dim) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]]) + (1/(m2^4))((1/(35 - 12 dim + dim^2))(-2 + dim)^2 m2^2 (4 m1^6 ((-7 + dim) (105 + dim (-39 + 4 dim)) m2^2 - (-4 + dim) (75 + (-16 + dim) dim) p2) + 4 (-7 + dim) m2^2 p2 ((-127 + (41 - 4 dim) dim) m1^4 + (-61 + (35 - 4 dim) dim) m1^2 p2 + (83 + dim (-37 + 4 dim)) p2^2) + (-4 + dim) (75 + (-16 + dim) dim) (m1^8 + 6 m1^4 p2^2 - 4 m1^2 p2^3 + p2^4)) b0[0, 0, m2]^2 + 2 ((-6 + dim) (-4 + dim) m1^10 + 5 (-4 + dim) m1^8 (4 (-3 + dim) m2^2 - (-6 + dim) p2) + p2^2 (-4 m2^2 + p2) (-16 (-9 + 2 dim) (-7 + 2 dim) m2^4 - 4 (48 + dim (-27 + 4 dim)) m2^2 p2 - (-6 + dim) (-4 + dim) p2^2) + 2 m1^6 (8 (-3 + dim) (-33 + 8 dim) m2^4 - 8 (-3 + dim) (-13 + 3 dim) m2^2 p2 + 5 (-6 + dim) (-4 + dim) p2^2) + 2 m1^4 (32 (87 + 4 (-9 + dim) dim) m2^6 - 5 (-6 + dim) (-4 + dim) p2^3 + 4 (-3 + dim) m2^2 p2 (-50 m2^2 + 3 (-6 + dim) p2)) + m1^2 p2 (128 (117 - 46 dim + 4 dim^2) m2^6 + 5 (-6 + dim) (-4 + dim) p2^3 + 16 (-3 + dim) m2^2 p2 ((53 - 8 dim) m2^2 + (-1 + dim) p2))) T[Df[k2, m2]^2 Df[k3, m2] Df[k4, m1]] + 8 m1^2 (32 (117 - 46 dim + 4 dim^2) m1^2 m2^4 p2 + 16 (75 - 34 dim + 4 dim^2) m2^4 (m1^4 + p2^2) + (-3 + dim) (4 m1^6 (2 (-7 + 2 dim) m2^2 - (-6 + dim) p2) - 8 (-7 + 2 dim) m2^2 p2 (m1^4 + m1^2 p2 - p2^2) + (-6 + dim) (m1^8 + 6 m1^4 p2^2 - 4 m1^2 p2^3 + p2^4))) T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]]))) /; m2 =!= 0;

T[Df[k1, 0]^3 Df[k2, m1_] Df[k3, 0] Df[k4, 0]] :=         (* T1'1'1'23'4' *)
(-2 (m1^2 + p2) (-9 + 2 $D) (-8 + 3 $D) T[Df[k2, m1] Df[k3, 0] Df[k4, 0]] + ((m1^4 + p2^2) (-4 + $D) (-48 + 13 $D) + 2 m1^2 p2 (312 + $D (-156 + 19 $D))) T[Df[k1, 0] Df[k2, m1] Df[k3, 0] Df[k4, 0]])/((m1^2 - p2)^4 (-8 + $D) (-6 + $D));

T[Df[k1, 0]^4 Df[k2, m1_] Df[k3, m2_] Df[k4, m3_]] :=     (* T1'1'1'1'234 *)
1/6 ((1/((m2^2 - m3^2) (-m1^2 + p2)^6))(m2^2 b0[0, 0, m2] - m3^2 b0[0, 0, m3]) ((1/(dim (8 + 6 dim + dim^2)))(-2 + dim)^2 m1^2 (2 (432 + dim (68 + dim (-45 + (-6 + dim) dim))) m1^2 p2 + (-4 + dim) (-72 + dim (-21 + dim (2 + dim))) (m1^4 + p2^2)) b0[0, 0, m1] - (-5 + dim) (-3 + dim) (m1^2 + p2) (2 (-10 + dim) m1^2 p2 + (-4 + dim) (m1^4 + p2^2)) b0[p2, 0, m1]) + ((1/(8 + 6 dim + dim^2))(-2 + dim)^2 m1^2 b0[0, 0, m1] (m2^2 (m1^2 (-24 (-8 + dim) (-6 + dim) m2^4 + 48 (-72 + (-4 + dim) dim) m2^2 m3^2 - 24 (48 + dim (6 + dim)) m3^4) p2^3 + 6 ((-8 + dim) (-6 + dim) m2^4 - 2 (-72 + (-4 + dim) dim) m2^2 m3^2 + (48 + dim (6 + dim)) m3^4) (m1^8 + 6 m1^4 p2^2 + p2^4) + 3 m1^6 ((144 + dim (-44 + (-1 + dim) dim)) m2^6 - m2^4 ((144 + dim (-88 + dim + 3 dim^2)) m3^2 + 8 (-8 + dim) (-6 + dim) p2) + m2^2 m3^2 ((-144 + dim (-44 + dim (5 + 3 dim))) m3^2 + 16 (-72 + (-4 + dim) dim) p2) - m3^4 ((-144 + dim^2 (3 + dim)) m3^2 + 8 (48 + dim (6 + dim)) p2))) b0[0, 0, m2] + m3^2 (-m1^2 (-24 (48 + dim (6 + dim)) m2^4 + 48 (-72 + (-4 + dim) dim) m2^2 m3^2 - 24 (-8 + dim) (-6 + dim) m3^4) p2^3 - 6 ((48 + dim (6 + dim)) m2^4 - 2 (-72 + (-4 + dim) dim) m2^2 m3^2 + (-8 + dim) (-6 + dim) m3^4) (m1^8 + 6 m1^4 p2^2 + p2^4) + 3 m1^6 ((-144 + dim^2 (3 + dim)) m2^6 + (-144 + dim (44 + dim - dim^2)) m3^6 + 8 (-8 + dim) (-6 + dim) m3^4 p2 + m2^4 ((144 + dim (44 - dim (5 + 3 dim))) m3^2 + 8 (48 + dim (6 + dim)) p2) + m2^2 m3^2 (1152 p2 + (-4 + dim) ((-36 + dim (13 + 3 dim)) m3^2 - 16 dim p2)))) b0[0, 0, m3]) - (1/(2 + dim)) 6 m3^2 (dim (6 + dim) m2^4 + 2 (36 - 7 dim^2) m2^2 m3^2 + (72 + dim (-54 + 13 dim)) m3^4) (-m1^2 + p2)^4 (m1^2 + p2) b0[0, 0, m3] b0[p2, 0, m1])/(dim (m2^2 - m3^2)^5 (-m1^2 + p2)^6) + (3 ((1/(8 + 6 dim + dim^2))(-2 + dim)^2 m1^2 p2 (m1^4 + m1^2 p2 - p2^2) b0[0, 0, m1] (m2^2 ((-144 + dim (44 + dim - dim^2)) m2^2 + (-144 + dim^2 (3 + dim)) m3^2) b0[0, 0, m2] + m3^2 (-(-144 + dim^2 (3 + dim)) m2^2 + (144 + dim (-44 + (-1 + dim) dim)) m3^2) b0[0, 0, m3]) + ((2 dim^3 m3^2 (-m1^2 + p2)^4 (m1^2 + p2) b0[0, 0, m3])/(2 + dim) - (-3 + dim) (-m1^2 + p2)^2 (2 (-6 + dim) m1^2 p2 + (-4 + dim) (m1^4 + p2^2)) (((-4 + dim) m2^4 - dim m2^2 m3^2) b0[0, 0, m2] + m3^2 (dim m2^2 - (-4 + dim) m3^2) b0[0, 0, m3])) b0[p2, 0, m1]))/(dim (m2^2 - m3^2)^3 (-m1^2 + p2)^6) + (1/((m2^2 - m3^2)^7)) 6 ((1/(dim (-m1^2 + p2)^2)) m2^2 m3^6 (4 (-3 + dim)^2 m2^2 (m1^2 + p2) + dim p2 (-(-3 + dim) m3^2 + p2) - dim m1^2 ((-3 + dim) m3^2 + 2 p2)) b0[0, 0, m2] b0[p2, 0, m1] + (m2^2 ((4 (-6 + dim) (12 - 13 dim + dim^3) m1^10 m2^6 m3^2)/dim + (4 + dim) ((2 + dim) m3^6 (m1^3 - m1 p2)^4 + (1/dim)(-3 + dim) m2^4 (-(-6 + dim) (-4 + dim) m1^10 m2^4 - 6 (-4 + (-4 + dim) dim) m1^10 m3^4 + (-(-6 + dim) (-4 + dim) m2^4 + 4 (-6 + dim) (-1 + dim) m2^2 m3^2 - 6 (-4 + (-4 + dim) dim) m3^4) p2 (-3 m1^8 + 2 m1^6 p2 + 2 m1^4 p2^2 - 3 m1^2 p2^3 + p2^4)))) b0[0, 0, m2] b0[p2, 0, m1])/((8 + 6 dim + dim^2) (-m1^2 + p2)^6) + (1/((-m1^2 + p2)^7))(m3^2 ((1/(-4 + dim^2)) 2 (7 (2 + dim) m1^12 m2^6 p2 - (2 + dim) m1^10 m2^6 (m1^4 + 21 p2^2) + (3 (-8 + dim) (2 + dim) m1^10 m2^4 m3^2 (m1^4 - 7 m1^2 p2 + 21 p2^2))/dim + (1/dim) 7 m1^2 m2^2 (dim (2 + dim) m2^4 - 3 (-8 + dim) (2 + dim) m2^2 m3^2 + 3 (-8 + dim) (-6 + dim) m3^4) p2^3 (5 m1^6 + 3 m1^2 p2^2 - p2^3) + (48 (-3 + dim)^2 m3^4 p2^2 (m1^6 m3^6 - m2^6 p2^3))/dim - (3 (-8 + dim) (-6 + dim) m2^2 m3^4 (m1^14 - 7 m1^12 p2 + 21 m1^10 p2^2 + 35 m1^6 p2^4 - p2^7))/dim + (1/dim)(-3 + dim) (m1^4 (20 (-66 + 7 dim) m2^6 m3^2 - 20 (-6 + dim) m3^8) p2^4 + m2^6 m3^2 (-12 (2 + dim) m1^12 + 20 (-6 + dim) p2^6) + 4 m2^4 m3^4 ((-30 + 9 dim) m1^12 + 3 (10 - 3 dim) p2^6 + m1^4 p2^3 (8 (14 - 3 dim) m2^2 + 15 (10 - 3 dim) p2)) + 4 m1^6 p2 (-5 (-6 + dim) m3^12 - 10 m2^10 ((6 + dim) m3^2 + 2 p2) + m2^4 m3^4 (5 (66 - 7 dim) m3^4 + 15 (-10 + 3 dim) m1^2 p2 + 8 (-14 + 3 dim) m3^2 p2) + 2 m2^2 m3^6 ((-78 + 11 dim) m3^4 + 2 (29 - 8 dim) m3^2 p2 + 10 (-18 + dim) p2^2) + m2^6 m3^2 (m2^2 (5 (42 + dim) m3^2 - 4 (-13 + dim) p2) + m1^2 (4 (-13 + dim) m3^2 - 5 (42 + dim) p2) + 20 (-18 + dim) (m3^4 - p2^2))))) + (1/((-2 + dim) dim)) 2 (m2^4 p2 ((dim m2^2 - 3 (-8 + dim) m3^2) p2^6 + m1^6 (12 (-3 + dim) m2^8 - 35 (dim m2^2 - 3 (-8 + dim) m3^2) p2^3)) + (1/(8 + 6 dim + dim^2)) 4 (-3 + dim) (m2^2 p2^5 ((-88 + 44 dim - 6 dim^2) m2^8 + 4 (32 + dim (-21 + 4 dim)) m2^6 m3^2 + 20 (-16 + 5 dim) m2^2 m3^6 + 2 (68 + (-24 + dim) dim) m3^8 + (72 + 7 (-2 + dim) dim) m3^6 p2) + m1^8 p2 (2 (28 + (-4 + dim) dim) m2^10 - 4 (32 + dim (-21 + 4 dim)) m3^10 + m2^2 m3^6 (4 (16 + (47 - 8 dim) dim) m2^2 + 6 (36 + dim (-38 + 7 dim)) m3^2 + 5 (216 + (70 - 11 dim) dim) p2)) + m1^4 p2^3 (-12 (-8 + dim) (-1 + dim) m2^10 + 4 (-16 + dim (-47 + 8 dim)) m2^8 m3^2 + 20 (16 - 5 dim) m3^10 + m2^2 m3^6 (4 (-152 + dim (41 + dim)) m3^2 + 5 (216 + dim (14 + 5 dim)) p2)) - (-6 + dim) (3 m1^12 ((4 + 3 dim) m2^2 m3^6 - (-4 + dim) m3^8) - 20 (-5 + dim) m1^8 m3^8 p2^2 + 2 (-2 + dim) m3^8 p2^6 + (-8 + dim) p2^2 (10 m1^6 (-m2^8 + m3^8) p2 + m2^8 (5 m1^8 + 10 m1^4 p2^2 + p2^4)))))) T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + (1/dim) m2^2 (-((42 m1^4 m3^4 (-3 (-8 + dim) m2^2 + dim m3^2) p2^5)/(-2 + dim)) + ((-3 + dim) (8 m3^2 p2^4 ((4 + dim) m1^4 (15 (-10 + 3 dim) m2^4 m3^2 + 5 (66 - 7 dim) m2^2 m3^4) + 2 (-(68 + (-24 + dim) dim) m2^8 + 10 (16 - 5 dim) m2^6 m3^2 - 2 (32 + dim (-21 + 4 dim)) m2^2 m3^6 + (44 + dim (-22 + 3 dim)) m3^8) p2 + m2^6 (-5 (216 + dim (14 + 5 dim)) m1^4 + 2 (216 + dim (-14 + 13 dim)) m1^2 p2 + (-72 - 7 (-2 + dim) dim) p2^2)) + 8 (-6 + dim) (m1^12 (-3 (-4 + dim) m2^8 + 3 (4 + 3 dim) m2^6 m3^2) + (8 - 7 dim) m1^2 m2^8 p2^5 + p2^4 (5 (4 + dim) m1^4 m2^8 + (-8 + 7 dim) m2^10 m3^2 + 20 (-5 + dim) m2^4 m3^8 + (56 - 13 dim) m2^2 m3^10 + 3 (-4 + dim) m3^12 - 2 (-2 + dim) m2^8 (m2^4 - p2^2)) + (-8 + dim) p2^3 (10 m1^6 m2^8 - 10 m2^6 m3^6 p2 + m3^8 (-10 m1^6 + 10 m1^4 p2 - 5 m1^2 p2^2 + p2^3)))))/((-2 + dim) (8 + 6 dim + dim^2)) + (1/(-4 + dim^2)) m3^2 (-160 (-18 + dim) (-3 + dim) m1^6 m2^6 p2^3 - 40 (-6 + dim) (-3 + dim) m2^8 m3^2 p2^4 - 126 (-8 + dim) (-6 + dim) m1^4 m2^4 p2^5 - 24 (-3 + dim) (-10 + 3 dim) m2^4 m3^2 (m1^12 + 4 m1^2 p2^5 - p2^6) + 6 (-8 + dim) m2^2 ((-6 + dim) m2^2 - (2 + dim) m3^2) (m1^14 - 7 m1^12 p2 + 21 m1^10 p2^2 - 35 m1^8 p2^3 + 35 m1^6 p2^4 + 7 m1^2 p2^6 - p2^7) + m3^4 (8 (-3 + dim) m2^2 p2^3 (20 (-18 + dim) m1^6 + p2^2 (2 (-78 + 11 dim) m1^2 + 12 (-3 + dim) m2^2 - 5 (-6 + dim) p2)) + (2 + dim) (-72 m1^12 m2^2 + 2 dim (m1^14 + m1^12 (12 m2^2 - 7 p2) + 21 m1^10 p2^2 - 35 m1^8 p2^3 + 35 m1^6 p2^4 + 7 m1^2 p2^6 - p2^7))))) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]]) + (1/(dim (8 + 6 dim + dim^2)))(((-8 + dim) m2^4 (-(-6 + dim) (-4 + dim) m2^4 + 3 (-6 + dim) (4 + dim) m2^2 m3^2 - 3 (2 + dim) (4 + dim) m3^4) b0[0, 0, m2] + (-3 (-8 + dim) (-6 + dim) (4 + dim) m2^2 m3^6 + (-8 + dim) (-6 + dim) (-4 + dim) m3^8 + (2 + dim) (4 + dim) (-dim m2^6 m3^2 + 3 (-8 + dim) m2^4 m3^4)) b0[0, 0, m3]) b0[p2, 0, m1] + (1/(-2 + dim)) 2 (-8 + dim) (-6 + dim) (-4 + dim) (-m3^8 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + m2^8 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]]))) + (1/((-m1^2 + p2)^7)) 6 ((m1^6 + ((-8 + dim) p2 (-3 m1^4 + ((-6 + dim) p2 (3 (4 + dim) m1^2 - (-4 + dim) p2))/(8 + 6 dim + dim^2)))/dim) (T[Df[k1, m3] Df[k3, m2] Df[k4, 0]] + (2 (m3^2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + m2^2 T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]]))/(-2 + dim)) + ((8 - 3 dim) (-(-8 + dim) (-6 + dim) (-4 + dim) p2^3 + (4 + dim) (dim (2 + dim) m1^6 + 3 (-8 + dim) m1^2 p2 (-(2 + dim) m1^2 + (-6 + dim) p2))) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] - 48 m1^2 ((-8 + dim) (4 + dim) m1^2 p2 (m1^2 + p2) - (8 + (-4 + dim) dim) (m1^6 + p2^3)) T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]])/((-2 + dim) dim (8 + 6 dim + dim^2))) - (3 ((1/(8 + 6 dim + dim^2))(-2 + dim)^2 m2^2 m3^2 (m2^2 + m3^2) (-m1^2 + p2)^4 ((-144 + dim^2 (3 + dim)) m1^2 + (-144 + dim (44 + dim - dim^2)) p2) b0[0, 0, m2] b0[0, 0, m3] + (-3 + dim) (2 (-6 + dim) m2^2 m3^2 + (-4 + dim) (m2^4 + m3^4)) (-m1^2 + p2)^4 (-4 p2 + dim (-m1^2 + p2)) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]] - 2 (-3 + dim) m1^2 ((1/(-4 + dim^2)) m2^2 (-32 m1^4 (3 (-3 + dim) m2^4 + (2 + dim) m2^2 m3^2 + 5 m3^4) p2^2 + (1/(4 + dim)) 16 (-m1^8 m2^2 ((44 + dim (-22 + 3 dim)) m2^2 + (28 + (-4 + dim) dim) m3^2) + m1^6 ((64 - 42 dim + 8 dim^2) m2^4 + (28 + (-4 + dim) dim) (3 m2^2 m3^2 + m3^4)) p2 + p2^3 (-2 m1^2 ((80 - 25 dim) m2^4 + (88 + (-34 + dim) dim) m2^2 m3^2 + 3 (-8 + dim) (-1 + dim) m3^4) + (2 (52 + dim (-31 + 4 dim)) m3^4 + (68 + (-24 + dim) dim) (m2^4 + 3 m2^2 m3^2)) p2))) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] + (4 p2^2 ((-8 + 3 dim) m1^2 (-6 (-72 + dim (26 + dim)) m2^2 m3^2 + (-6 + dim) (-28 + 11 dim) (m2^4 + m3^4)) p2 T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] + 4 m3^2 (2 (52 + dim (-31 + 4 dim)) m2^4 + (68 + (-24 + dim) dim) (3 m2^2 m3^2 + m3^4)) p2^2 T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] - 4 m1^2 (2 (-8 + dim) (-6 + dim) m2^2 m3^2 + (44 + dim (-22 + 3 dim)) (m2^4 + m3^4)) (2 m1^4 - 3 p2^2) T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]]))/((-2 + dim) (8 + 6 dim + dim^2)))))/(dim (m2^2 - m3^2)^4 (-m1^2 + p2)^7) + (6 ((1/(8 + 6 dim + dim^2))(-2 + dim)^2 m2^2 m3^2 (-m1^2 + p2)^2 ((48 + dim (6 + dim)) m1^4 - 2 (-72 + (-4 + dim) dim) m1^2 p2 + (-8 + dim) (-6 + dim) p2^2) b0[0, 0, m2] b0[0, 0, m3] - (1/(2 + dim))(-3 + dim) (m2^2 + m3^2) (-m1^2 + p2)^2 (dim^2 (-m1^2 + p2)^2 + 24 p2 (m1^2 + p2) + 2 dim (m1^4 + 4 m1^2 p2 - 5 p2^2)) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]] + (-3 + dim) ((1/(-4 + dim^2)) m1^2 m2^2 (8 m1^4 (5 (-6 + dim) m2^2 + 3 (2 + dim) m3^2) p2 + (1/(4 + dim))(-8 (-8 + dim) (-6 + dim) m1^6 m2^2 - 24 (4 + dim) (-10 + 3 dim) m1^2 (m2^2 + m3^2) p2^2 + 8 ((72 + 7 (-2 + dim) dim) m2^2 + 3 (-6 + dim) (4 + 3 dim) m3^2) p2^3)) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] + (2 (-8 + 3 dim) m1^2 (m2^2 + m3^2) ((-8 + dim) (-6 + dim) m1^6 - 8 (-3 + dim) (4 + dim) m1^4 p2 + 8 (7 - 2 dim) dim p2^3) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] + 8 m3^2 (-3 (4 + dim) (-10 + 3 dim) m1^4 (m2^2 + m3^2) p2^2 + (72 + 7 (-2 + dim) dim) m1^2 m3^2 p2^3 + (-6 + dim) (-(-8 + dim) m1^8 m3^2 + 3 (4 + 3 dim) m1^2 m2^2 p2^3 + (-3 (-4 + dim) m2^2 - 2 (-2 + dim) m3^2) p2^4)) T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] - 24 (m2^2 + m3^2) (m1^3 - m1 p2)^2 (-2 (-32 + dim (6 + dim)) m1^2 p2 + (-6 + dim) (-4 + dim) (m1^4 + p2^2)) T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]])/((-2 + dim) (8 + 6 dim + dim^2)))))/(dim (m2^2 - m3^2)^2 (-m1^2 + p2)^7) + (1/((m2^2 - m3^2)^6)) 6 ((1/(6 (-m1^2 + p2)))((1/(dim (8 + 6 dim + dim^2)))(-2 + dim)^2 m2^2 m3^2 (2 (432 + dim (68 + dim (-45 + (-6 + dim) dim))) m2^2 m3^2 + (-4 + dim) (-72 + dim (-21 + dim (2 + dim))) (m2^4 + m3^4)) b0[0, 0, m2] b0[0, 0, m3] + (-5 + dim) (-3 + dim) (-3 (-8 + dim) m2^2 m3^2 (m2^2 + m3^2) - (-4 + dim) (m2^6 + m3^6)) T[Df[k1, m3] Df[k3, m2] Df[k4, 0]]) + ((-3 + dim) (-2 (8 - 3 dim) (m1^12 (m2^2 + m3^2) (-2 (-18 + dim) (4 + dim) m2^2 m3^2 + (-8 + dim) (-6 + dim) (m2^4 + m3^4)) + m1^8 (2 (152 + dim (14 + 9 dim)) m2^4 m3^4 + 4 (8 + (-24 + dim) dim) m2^2 m3^2 (m2^4 + m3^4) + (-184 + (82 - 13 dim) dim) (m2^8 + m3^8)) p2 + 2 (2 + dim) (4 + dim) m1^6 m2^8 p2^2 + 6 (4 + dim) (-10 + 3 dim) m1^4 m2^10 p2^2 - 2 (4 + dim) m1^6 m3^2 (2 (-14 + 13 dim) m2^4 m3^2 - (2 + dim) m3^6 - 4 (-4 + 3 dim) m2^2 (m2^4 + m3^4)) p2^2 + (-6 + dim) (-16 + 5 dim) m2^10 p2^4 - m1^2 (2 (-472 + dim (86 + 21 dim)) m2^4 m3^4 - 4 (-32 + dim (-24 + 11 dim)) m2^2 m3^2 (m2^4 + m3^4) + (344 + dim (-182 + 23 dim)) (m2^8 + m3^8)) p2^4 + (-4 + dim) (-26 + 7 dim) m2^8 p2^5 + 2 (-136 + dim (22 + 5 dim)) m2^4 m3^4 p2^5 + (-4 + dim) (-26 + 7 dim) m3^8 p2^5 + 32 m2^2 m3^2 (m2^4 + m3^4) p2^5 + 4 (8 - 3 dim) dim m2^2 m3^2 (m2^4 + m3^4) p2^5 - ((-192 + (-14 + dim) dim) m2^2 m3^2 (m2^2 + m3^2) - (-8 + dim) (-6 + dim) (m2^6 + m3^6)) p2^4 (15 m1^4 + p2^2) - m3^2 (-3 m2^8 + 2 m2^6 m3^2 + 2 m2^4 m3^4 - 3 m2^2 m3^6 + m3^8) p2^2 (-6 (4 + dim) (-10 + 3 dim) m1^4 - (-6 + dim) (-16 + 5 dim) p2^2) + m1^2 ((192 - (-14 + dim) dim) m2^2 m3^2 (m2^2 + m3^2) + (-8 + dim) (-6 + dim) (m2^6 + m3^6)) p2^2 (15 m1^6 - 20 m1^4 p2 - 6 p2^3) + m1^10 ((72 + dim (-34 + 5 dim)) (m2^8 + m3^8) + 6 (-192 + (-14 + dim) dim) m2^2 m3^4 p2 - 2 m2^4 ((72 + (-2 + dim) dim) m3^4 - 3 (-192 + (-14 + dim) dim) m3^2 p2) + 2 (-8 + dim) (-2 dim m2^2 m3^2 (m2^4 + m3^4) - 3 (-6 + dim) (m2^6 + m3^6) p2))) T[Df[k2, m3] Df[k3, m2] Df[k4, m1]] + m1^2 (m3^2 (8 ((864 - dim (2 + 17 dim)) m2^4 m3^2 + (384 + dim (22 + 19 dim)) m2^2 m3^4 + (-6 + dim) (5 (-8 + dim) m2^6 + (8 - 7 dim) m3^6)) p2^5 - 8 m1^8 (2 ((28 + (-4 + dim) dim) m2^2 + (44 + dim (-22 + 3 dim)) m3^2) (-m2^2 m3 + m3^3)^2 - ((-8 + dim) (-6 + dim) m2^6 + (288 + dim (86 + 11 dim)) m2^4 m3^2 + (768 + (62 - 25 dim) dim) m2^2 m3^4 + (-6 + dim) (-56 + 13 dim) m3^6) p2)) T[Df[k2, m3]^2 Df[k3, m2] Df[k4, m1]] + 8 m1^6 m2^2 p2 (m1^2 ((-6 + dim) (-56 + 13 dim) m2^6 + (768 + (62 - 25 dim) dim) m2^4 m3^2 + (288 + dim (86 + 11 dim)) m2^2 m3^4 + (-8 + dim) (-6 + dim) m3^6) - 5 (4 (-6 + dim) (-5 + dim) m2^6 + (336 + (26 - 7 dim) dim) m2^4 m3^2 + 2 (108 + dim (16 + dim)) m2^2 m3^4 + (-8 + dim) (-6 + dim) m3^6) p2) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m1]] + 8 ((-8 + dim) (-6 + dim) (m2^6 + m3^6) (2 m1^2 - p2) p2 (3 m1^4 - 3 m1^2 p2 + p2^2) (m1^4 - m1^2 p2 + p2^2) - (4 (-52 + dim (6 + dim)) m2^4 m3^4 - 8 (-2 + (-4 + dim) dim) m2^2 m3^2 (m2^4 + m3^4) + 2 (44 + dim (-22 + 3 dim)) (m2^8 + m3^8)) (m1^10 - 3 m1^8 p2 + 2 m1^4 p2^3 + p2^5) + (m2^2 + m3^2) (-(-8 + dim) (-6 + dim) m1^12 (m2^4 + m3^4) - m2^2 m3^2 (-2 (-18 + dim) (4 + dim) m1^12 + (-192 + (-14 + dim) dim) m1^2 p2 (6 m1^8 - 15 m1^6 p2 + 20 m1^4 p2^2 + 6 p2^4) + (192 - (-14 + dim) dim) (15 m1^4 p2^4 + p2^6)))) T[Df[k2, m1]^2 Df[k3, m3] Df[k4, m2]])))/((-2 + dim) dim (8 + 6 dim + dim^2) (-m1^2 + p2)^7))) /; m2 =!= m3;

T[Df[k1, 0]^4 Df[k2, m1_] Df[k3, m2_] Df[k4, m2_]] :=     (* T1'1'1'1'23m4m *)
(1/13440)((8 m1^2 (m1^2 + p2) (-2 + $D)^2 (228 + 11 (-9 + $D) $D) b0[0, 0, m1] b0[0, 0, m2])/(m2^2 (-m1^2 + p2)^4) - ((-8 + $D) (-6 + $D) (-4 + $D) (-2 + $D) b0[0, 0, m2] b0[p2, 0, m1])/m2^6 + (1/((-m1^2 + p2)^6)) 13440 (-2 + $D) b0[0, 0, m2] (1/420 m1^2 (-2 + $D) (2 m1^2 p2 (557 + $D (-226 + 19 $D)) + (m1^4 + p2^2) (357 + $D (-166 + 19 $D))) b0[0, 0, m1] + 1/48 (-12 m1^2 p2 (m1^2 + p2) (-8 + $D) (-5 + $D) + (2 m1^2 p2 (2 m1^4 + 2 p2^2 + m1^2 p2 (-8 + $D)) (-4 + $D))/m2^2 - 4 (m1^6 + p2^3) (-5 + $D) (-4 + $D) - ((m1^8 + p2^4) (-4 + $D)^2)/m2^2) (-3 + $D) b0[p2, 0, m1]) + (1/(m2^4 (-m1^2 + p2)^2)) 4 (-6 + $D) (-2 + $D) b0[0, 0, m2] (m1^2 (-8 + $D) (-2 + $D) b0[0, 0, m1] - 7 (m1^2 + p2) (-4 + $D) (-3 + $D) b0[p2, 0, m1]) + (1/((-m1^2 + p2)^7)) 2 (32 (p2^3 (-11 + 2 $D) (-9 + 2 $D) (-7 + 2 $D) + m1^6 (-987 + 2 $D (285 - 58 $D + 4 $D^2)) + m1^4 p2 (-5631 + 2 $D (1445 + 6 $D (-39 + 2 $D))) + m1^2 p2^2 (-4977 + 2 $D (1359 + 2 $D (-115 + 6 $D)))) (-((m2^2 (-2 + $D)^2 b0[0, 0, m2]^2)/(-3 + $D)) + 2 (-8 + 3 $D) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]]) + (1/(m2^6))(((-m1^14 + 7 m1^12 p2 - 21 m1^10 p2^2 + 35 m1^8 p2^3 - 35 m1^6 p2^4 + 21 m1^4 p2^5 + p2^6 (-7 m1^2 - 4 m2^2 + p2)) (-8 + $D) - 28 m1^12 m2^2 (-3 + $D)) (-6 + $D) (-4 + $D) + 64 m2^6 (-3 + $D) (-5 m1^8 (9 - 2 $D)^2 + p2^4 (27 - 4 (-3 + $D) $D) - 4 m1^6 p2 (327 - 86 $D + 4 $D^2) + 4 m1^2 p2^3 (225 - 54 $D + 4 $D^2) + 2 m1^4 p2^2 (393 + 4 $D (-40 + 3 $D))) + 4 m2^2 p2 (-6 + $D) (p2^4 (-4 m2^2 + p2) (68 - 39 $D + 6 $D^2) + m1^2 (-3 + $D) (2 p2^4 (16 - 9 $D) + 5 m1^6 p2 (44 - 9 $D) + 20 m1^4 p2^2 (-8 + $D) + 5 m1^2 p2^3 (4 + 3 $D) + 2 m1^8 (-64 + 15 $D))) + 256 m2^8 (-p2^3 (-11 + 2 $D) (-9 + 2 $D) (-7 + 2 $D) + m1^6 (987 - 2 $D (285 - 58 $D + 4 $D^2)) + m1^4 p2 (5631 - 2 $D (1445 + 6 $D (-39 + 2 $D))) + m1^2 p2^2 (4977 - 2 $D (1359 + 2 $D (-115 + 6 $D)))) + m2^4 (16 p2^5 (-9 + 2 $D) (68 - 39 $D + 6 $D^2) + 8 m1^2 (-3 + $D) (10 m1^6 p2 (68 - 39 $D + 6 $D^2) + 2 (2 m1^4 p2^2 + p2^4) (368 + 3 $D (-43 + 2 $D)) - 4 m1^2 p2^3 (604 + 3 $D (-79 + 6 $D)) - m1^8 (608 + 6 $D (-49 + 6 $D))))) T[Df[k2, m2]^2 Df[k3, m2] Df[k4, m1]] - 1024 m1^2 (-6 + $D) ((m1^6 + p2^3) (35 + 2 (-8 + $D) $D) + m1^2 p2 (m1^2 + p2) (221 - 80 $D + 6 $D^2)) T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]]) - (1/(m2^6 (-m1^2 + p2))) ((m2^2 (-13 + $D) (-4 + $D) (-2 + $D)^2 (84 + (-15 + $D) $D) b0[0, 0, m2]^2)/((-9 + $D) (-7 + $D)) + (-8 + $D) (-6 + $D) (-3 + $D) ((16 - 6 $D) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]] + 8 m1^2 T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]])) - (1/(m2^4 (-m1^2 + p2)^3)) 4 ((1/((-7 + $D) (-5 + $D))) m2^2 (-2 + $D)^2 (m1^2 (6300 + $D (-4373 + $D (1142 + 3 $D (-45 + 2 $D)))) + p2 (5008 + $D (-3871 + $D (1090 + $D (-133 + 6 $D))))) b0[0, 0, m2]^2 + 2 (-3 + $D) (-(-8 + 3 $D) (m1^2 (-9 + 2 $D) (-14 + 3 $D) + p2 (110 + $D (-53 + 6 $D))) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]] + 8 m1^2 (m1^2 + p2) (59 + 3 (-9 + $D) $D) T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]])) + (1/((-m1^2 + p2)^5)) 16 (-(1/(-5 + $D))(-2 + $D)^2 (p2^2 (9 - 2 $D)^2 (-13 + 3 $D) + m1^4 (-1425 + $D (811 + 12 (-14 + $D) $D)) + 2 m1^2 p2 (-1929 + $D (1063 + 4 $D (-49 + 3 $D)))) b0[0, 0, m2]^2 + (1/(m2^2))(-3 + $D) (2 (-8 + 3 $D) (2 m1^2 p2 (291 + 4 $D (-32 + 3 $D)) + (-9 + 2 $D) (m1^4 (-23 + 6 $D) + p2^2 (-19 + 6 $D))) T[Df[k2, m2] Df[k3, m2] Df[k4, m1]] - 8 m1^2 (3 (m1^4 + p2^2) (-9 + 2 $D) (-7 + 2 $D) + 2 m1^2 p2 (291 + 4 $D (-32 + 3 $D))) T[Df[k2, m1]^2 Df[k3, m2] Df[k4, m2]]))) /; m2 =!= 0;

T[Df[k1, 0]^4 Df[k2, m1_] Df[k3, 0] Df[k4, 0]] :=     (* T1'1'1'1'23'4' *)
((8 - 3 $D) (2 m1^2 p2 (-6 + $D) (-82 + 19 $D) + (m1^4 + p2^2) (300 + $D (-124 + 13 $D))) T[Df[k2, m1] Df[k3, 0] Df[k4, 0]] + 4 (m1^2 + p2) (-9 + 2 $D) (5 (m1^4 + p2^2) (-4 + $D)^2 + 2 m1^2 p2 (-6 + $D) (-38 + 11 $D)) T[Df[k1, 0] Df[k2, m1] Df[k3, 0] Df[k4, 0]])/((m1^2 - p2)^6 (-10 + $D) (-8 + $D) (-6 + $D));

(* reduction for T1'2234 added by SP *)

T[Df[k1, 0] Df[k2, m2_]^2 Df[k3, m3_] Df[k4, m4_]] :=      (* T1'2234 *)
1/(m2^2 - p2) 1/(m3^2 - m4^2) (-3 + $D) ((m3^2 b0[0, 0, m3] - m4^2 b0[0, 0, m4]) b0[p2, 0, m2] + 2/(-2 + $D) (m4^2 T[Df[k2, m4]^2 Df[k3, m3] Df[k4, m2]] - m3^2 T[Df[k2, m3]^2 Df[k3, m4] Df[k4, m2]])) + 1/(m2^2 - p2)^2 1/(-2 + $D) ((-2 + $D) T[Df[k1, m4] Df[k3, m3] Df[k4, 0]] + (8 - 3 $D) T[Df[k2, m4] Df[k3, m3] Df[k4, m2]] + 2 m4^2 T[Df[k2, m4]^2 Df[k3, m3] Df[k4, m2]] + 2 m3^2 T[Df[k2, m3]^2 Df[k3, m4] Df[k4, m2]] + (-m2^2 (-6 + $D) + p2 (-2 + $D)) T[Df[k2, m2]^2 Df[k3, m4] Df[k4, m3]]) /; m3 =!= m4;

T[Df[k1, 0] Df[k2, m2_]^2 Df[k3, m3_] Df[k4, m3_]] :=      (* T1'223m4m *)
((-3 + $D) (-2 + $D) b0[0, 0, m3] b0[p2, 0, m2])/(2 (m2^2 - p2)) + 1/(m2^2 - p2)^2 ((4 - $D) (-2 + $D)^2/(2 (-3 + $D)) m3^2 b0[0, 0, m3]^2 + (-4 + $D) (-8 + 3 $D) T[Df[k2, m3] Df[k3, m3] Df[k4, m2]] + (4 m3^2 (4 - $D) + (-m2^2 + p2) (-3 + $D)) T[Df[k2, m3]^2 Df[k3, m3] Df[k4, m2]] + (p2 + m2^2 (15 - 4 $D)) T[Df[k2, m2]^2 Df[k3, m3] Df[k4, m3]]);
...
T[Df[k1,m_]^2 Df[k3,m_] Df[k4,0]]:=                   (* T1134' *)
 ...
 T[Df[k1,m_]^2 Df[k2,m_] Df[k3,m_] Df[k4,0]]:=                   (* T11234' *)
(-2 + dim) B0[0, 0, m] B0[p2, m, m]/(8 m^2) +
(-2 + dim) (2 m^2 - p2) T[Df[k1, m] Df[k3, m] Df[k4, 0]]/(2 m^2 (4 m^2 - p2) p2) +
(16 m^2 - 6 dim m^2 - 8 p2 + 3 dim p2) T[Df[k2, m] Df[k3, m] Df[k4, 0]]/(8 m^4 p2 - 2 m^2 p2^2) +
(-8 m^2 + (-1 + dim) p2) T[Df[k1, m] Df[k2, m] Df[k3, m] Df[k4, 0]]/(16 m^4 - 4 m^2 p2) +
(-1/(4 m^2) + 1/p2 + 2/(-4 m^2 + p2)) T[Df[k2, m]^2 Df[k3, m] Df[k4, 0]] - 
T[Df[k2, 0]^2 Df[k3, m] Df[k4, m]]/(2 m^2) /; m =!= 0;
