{g[hTTL, hid_] :> ZHu[hid]*(ht/Sqrt[2]), 
 ...
 g[StStStStV, s1_, s2_, s3_, s4_] :> 
  ...
  g[StStSbSb, s2, s1, s4, s3], g[NTStL, n1_, s2_] :> 
  ht*USf[s2, 2, 3, 3]*ZNeuCgl[n1, 4], gC[NTStL, n1_, s2_] :> 
  ht*USfC[s2, 2, 3, 3]*ZNeugl[n1, 4], g[NTStR, n1_, s2_] :> 
  ht*USf[s2, 1, 3, 3]*ZNeugl[n1, 4], gC[NTStR, n1_, s2_] :> 
  ht*USfC[s2, 1, 3, 3]*ZNeuCgl[n1, 4], g[NBSbL, n1_, s2_] :> 
  hb*USf[s2, 2, 4, 3]*ZNeuCgl[n1, 3], gC[NBSbL, n1_, s2_] :> 
  hb*USfC[s2, 2, 4, 3]*ZNeugl[n1, 3], g[NBSbR, n1_, s2_] :> 
  hb*USf[s2, 1, 4, 3]*ZNeugl[n1, 3], gC[NBSbR, n1_, s2_] :> 
  hb*USfC[s2, 1, 4, 3]*ZNeuCgl[n1, 3], g[CTSbL, c1_, s2_] :> 
  (-hb)*UChaCgl[c1, 2]*USf[s2, 2, 4, 3], gC[CTSbL, c1_, s2_] :> 
  (-hb)*UChagl[c1, 2]*USfC[s2, 2, 4, 3], g[CTSbR, c1_, s2_] :> 
  (-ht)*IndexDelta[2, c1]*USf[s2, 1, 4, 3], gC[CTSbR, c1_, s2_] :> 
  (-ht)*IndexDelta[2, c1]*USfC[s2, 1, 4, 3], 
