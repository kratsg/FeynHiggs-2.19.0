...
RenConst[dZ11H2gl] := dZ11H2gldiv2/del^2 + dZ11H2gldiv/del + dZ11H2glfin

RenConst[dZ22H2gl] := dZ22H2gldiv2/del^2 + dZ22H2gldiv/del + dZ22H2glfin

RenConst[dZ12H2gl] := dZ12H2glfin
				       
RenConst[dZ21H2gl] := Conjugate[dZ12H2glfin]
