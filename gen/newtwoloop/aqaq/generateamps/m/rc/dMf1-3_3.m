 ...
 {{dMf1[-1, 3, 3] -> 
    ...
    -((dMT1OS*((-(DiagMark[0, MB]*(MT*g[HpTBR, 2]*gC[HpTBR, 2] + 
        ...
        (DiagMark[MChagl[Cha3], MSf[Sfe3, 4, 3]]*
           (-1/32*((g[CTSbR, Cha3, Sfe3]*gC[CTSbL, Cha3, Sfe3] + g[CTSbL, 
                 Cha3, Sfe3]*gC[CTSbR, Cha3, Sfe3])*MChagl[Cha3]*
              Re[B0fin[MT2, MChagl[Cha3]^2, MSf2[Sfe3, 4, 3]]]) - 
        ...
        MT*(DiagMark[0, MB]*(-1/32*(g[HpTBL, 2]*gC[HpTBL, 2]*Re[B0fin[MT2, 0, 
                MB2]]) + ((g[HpTBL, 2]*gC[HpTBL, 2] + g[HpTBR, 2]*
          ...
          (DiagMark[MB, MHin]*(g[HpTBL, 1]*gC[HpTBL, 1] + g[HpTBR, 1]*
           ...
           (64*MT2) + DiagMark[MHin, MT]*(-1/32*((g[hTTL, 2]^2 + g[hTTL, 3]^
                2 + g[hTTR, 2]^2 + g[hTTR, 3]^2)*Re[B0fin[MT2, MHin^2, 
                MT2]]) + ((g[hTTL, 2]*g[hTTR, 2] + g[hTTL, 3]*g[hTTR, 3])*
   ...
   dMf1[1, 3, 3] -> 
    -((dMT1OS*((-(DiagMark[0, MB]*(MT*g[HpTBR, 2]*gC[HpTBR, 2] + 
        ...
        (DiagMark[MChagl[Cha3], MSf[Sfe3, 4, 3]]*
           (-1/32*((g[CTSbR, Cha3, Sfe3]*gC[CTSbL, Cha3, Sfe3] + g[CTSbL, 
                 Cha3, Sfe3]*gC[CTSbR, Cha3, Sfe3])*MChagl[Cha3]*
              Re[B0del[MT2, MChagl[Cha3]^2, MSf2[Sfe3, 4, 3]]]) - 
            (MT*(g[CTSbL, Cha3, Sfe3]*gC[CTSbL, Cha3, Sfe3] + g[CTSbR, Cha3, 
          ...
          DiagMark[MNeugl[Neu3], MSf[Sfe3, 3, 3]]*
           (-1/32*((MT*(g[NTStL, Neu3, Sfe3]*gC[NTStL, Neu3, Sfe3] + 
               ...
               (g[NTStR, Neu3, Sfe3]*gC[NTStL, Neu3, Sfe3] + 
                 g[NTStL, Neu3, Sfe3]*gC[NTStR, Neu3, Sfe3])*MNeugl[Neu3])*
              Re[B0del[MT2, MNeugl[Neu3]^2, MSf2[Sfe3, 3, 3]]]) - 
            (MT*(g[NTStL, Neu3, Sfe3]*gC[NTStL, Neu3, Sfe3] + g[NTStR, Neu3, 
                ...
                Re[MNeugl[Neu3]^2] - Re[B0del[MT2, MNeugl[Neu3]^2, 
                  MSf2[Sfe3, 3, 3]]*(MT2 - MNeugl[Neu3]^2 + MSf2[Sfe3, 3, 
                   3])]))/(64*MT2))*SumOver[Neu3, 4])*SumOver[Sfe3, 2] + 
        MT*(DiagMark[0, MB]*(-1/32*(g[HpTBL, 2]*gC[HpTBL, 2]*Re[B0del[MT2, 0, 
                MB2]]) + ((g[HpTBL, 2]*gC[HpTBL, 2] + g[HpTBR, 2]*
          ...
          (DiagMark[MB, MHin]*(g[HpTBL, 1]*gC[HpTBL, 1] + g[HpTBR, 1]*
           ...
           (64*MT2) + DiagMark[MHin, MT]*(-1/32*((g[hTTL, 2]^2 + g[hTTL, 3]^
                2 + g[hTTR, 2]^2 + g[hTTR, 3]^2)*Re[B0del[MT2, MHin^2, 
                MT2]]) + ((g[hTTL, 2]*g[hTTR, 2] + g[hTTL, 3]*g[hTTR, 3])*
