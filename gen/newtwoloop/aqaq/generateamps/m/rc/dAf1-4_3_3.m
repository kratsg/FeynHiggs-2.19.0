{dAf1[4, 3, 3] -> RC[-1, dAf1[-1, 4, 3, 3]], 
 {{dAf1[-1, 4, 3, 3] -> ((MUEC*TB - Af[4, 3, 3])*
      ...
      ((-1/32*(DiagMark[MHin]*(g[hhSbSb, 2, 2, 2, 2] + g[hhSbSb, 3, 3, 2, 
              2] + 2*g[HpHpSbSb, 1, 1, 2, 2])*Re[MHin^2]) + 
          DiagMark[MT, MChagl[Cha3]]*(((g[CTSbL, Cha3, 1]*gC[CTSbL, Cha3, 
            ...
            (MT*(-(g[CTSbR, Cha3, 1]*gC[CTSbL, Cha3, 1]) + g[CTSbR, Cha3, 2]*
                 gC[CTSbL, Cha3, 2] - g[CTSbL, Cha3, 1]*gC[CTSbR, Cha3, 1] + 
                g[CTSbL, Cha3, 2]*gC[CTSbR, Cha3, 2])*MChagl[Cha3] + 
              (-(g[CTSbL, Cha3, 1]*gC[CTSbL, Cha3, 1]) + g[CTSbL, Cha3, 2]*
                 gC[CTSbL, Cha3, 2] - g[CTSbR, Cha3, 1]*gC[CTSbR, Cha3, 1] + 
                g[CTSbR, Cha3, 2]*gC[CTSbR, Cha3, 2])*(MT2 + 
                Re[MChagl[Cha3]^2]))/8)*SumOver[Cha3, 2] + 
          DiagMark[MB, MNeugl[Neu3]]*(((g[NBSbL, Neu3, 1]*gC[NBSbL, Neu3, 
                 1] + g[NBSbR, Neu3, 1]*gC[NBSbR, Neu3, 1])*MSf2[1, 4, 3])/
             16 - ((g[NBSbL, Neu3, 2]*gC[NBSbL, Neu3, 2] + g[NBSbR, Neu3, 2]*
                gC[NBSbR, Neu3, 2])*MSf2[2, 4, 3])/16 + 
            (MB*(-(g[NBSbR, Neu3, 1]*gC[NBSbL, Neu3, 1]) + g[NBSbR, Neu3, 2]*
                 gC[NBSbL, Neu3, 2] - g[NBSbL, Neu3, 1]*gC[NBSbR, Neu3, 1] + 
                g[NBSbL, Neu3, 2]*gC[NBSbR, Neu3, 2])*MNeugl[Neu3] + 
              (-(g[NBSbL, Neu3, 1]*gC[NBSbL, Neu3, 1]) + g[NBSbL, Neu3, 2]*
                 gC[NBSbL, Neu3, 2] - g[NBSbR, Neu3, 1]*gC[NBSbR, Neu3, 1] + 
                g[NBSbR, Neu3, 2]*gC[NBSbR, Neu3, 2])*(MB2 + 
                Re[MNeugl[Neu3]^2]))/8)*SumOver[Neu3, 4] + 
          (DiagMark[MHin, MSf[Sfe3, 3, 3]]*((g[HpStSb, 1, Sfe3, 1]*
                gC[HpStSb, 1, Sfe3, 1])/16 - (g[HpStSb, 1, Sfe3, 2]*
                gC[HpStSb, 1, Sfe3, 2])/16) + DiagMark[0, MSf[Sfe3, 3, 3]]*
             ((g[HpStSb, 2, Sfe3, 1]*gC[HpStSb, 2, Sfe3, 1])/16 - 
              (g[HpStSb, 2, Sfe3, 2]*gC[HpStSb, 2, Sfe3, 2])/16) + 
            DiagMark[MSf[Sfe3, 3, 3]]*(g[StStSbSb, Sfe3, Sfe3, 1, 1]/16 - 
              g[StStSbSb, Sfe3, Sfe3, 2, 2]/16)*MSf2[Sfe3, 3, 3] + 
            (DiagMark[MHin, MSf[Sfe3, 4, 3]]*(g[hSbSb, 2, 1, Sfe3]*
                 g[hSbSb, 2, Sfe3, 1] - g[hSbSb, 2, 2, Sfe3]*g[hSbSb, 2, 
                  Sfe3, 2] + g[hSbSb, 3, 1, Sfe3]*g[hSbSb, 3, Sfe3, 1] - 
        ...
        ((DiagMark[MHin]*(gC[hhSbSb, 2, 2, 2, 1] + gC[hhSbSb, 3, 3, 2, 1] + 
          ...
          DiagMark[MT, MChagl[Cha3]]*((-(MT*Conjugate[MChagl[Cha3]]*
                (g[CTSbR, Cha3, 2]*gC[CTSbL, Cha3, 1] + g[CTSbL, Cha3, 2]*
                  gC[CTSbR, Cha3, 1])) - MT2*(g[CTSbL, Cha3, 2]*gC[CTSbL, 
                  Cha3, 1] + g[CTSbR, Cha3, 2]*gC[CTSbR, Cha3, 1]))/8 + 
            (g[CTSbL, Cha3, 2]*gC[CTSbL, Cha3, 1] + g[CTSbR, Cha3, 2]*gC[
                CTSbR, Cha3, 1])*((MSf2[1, 4, 3] + MSf2[2, 4, 3])/32 - 
              Re[MChagl[Cha3]^2]/8))*SumOver[Cha3, 2] + 
          DiagMark[MB, MNeugl[Neu3]]*((-(MB*Conjugate[MNeugl[Neu3]]*
                (g[NBSbR, Neu3, 2]*gC[NBSbL, Neu3, 1] + g[NBSbL, Neu3, 2]*
                  gC[NBSbR, Neu3, 1])) - MB2*(g[NBSbL, Neu3, 2]*gC[NBSbL, 
                  Neu3, 1] + g[NBSbR, Neu3, 2]*gC[NBSbR, Neu3, 1]))/8 + 
        ...
        ((DiagMark[MHin]*(g[hhSbSb, 2, 2, 2, 1] + g[hhSbSb, 3, 3, 2, 1] + 
          ...
          DiagMark[MT, MChagl[Cha3]]*
           ((-(MT2*(g[CTSbL, Cha3, 1]*gC[CTSbL, Cha3, 2] + g[CTSbR, Cha3, 1]*
                  gC[CTSbR, Cha3, 2])) - MT*(g[CTSbR, Cha3, 1]*gC[CTSbL, 
                  Cha3, 2] + g[CTSbL, Cha3, 1]*gC[CTSbR, Cha3, 2])*MChagl[
                Cha3])/8 + (g[CTSbL, Cha3, 1]*gC[CTSbL, Cha3, 2] + 
              g[CTSbR, Cha3, 1]*gC[CTSbR, Cha3, 2])*((MSf2[1, 4, 3] + 
                MSf2[2, 4, 3])/32 - Re[MChagl[Cha3]^2]/8))*SumOver[Cha3, 2] + 
          DiagMark[MB, MNeugl[Neu3]]*
           ((-(MB2*(g[NBSbL, Neu3, 1]*gC[NBSbL, Neu3, 2] + g[NBSbR, Neu3, 1]*
                  gC[NBSbR, Neu3, 2])) - MB*(g[NBSbR, Neu3, 1]*gC[NBSbL, 
                  Neu3, 2] + g[NBSbL, Neu3, 1]*gC[NBSbR, Neu3, 2])*MNeugl[
                Neu3])/8 + (g[NBSbL, Neu3, 1]*gC[NBSbL, Neu3, 2] + 
              g[NBSbR, Neu3, 1]*gC[NBSbR, Neu3, 2])*((MSf2[1, 4, 3] + 
                MSf2[2, 4, 3])/32 - Re[MNeugl[Neu3]^2]/8))*SumOver[Neu3, 4] + 
