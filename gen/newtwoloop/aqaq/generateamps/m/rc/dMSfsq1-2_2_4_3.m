 ...
 {{dMSfsq1[-1, 2, 2, 4, 3] -> 
    ((DiagMark[MHin]*(g[hhSbSb, 2, 2, 2, 2] + g[hhSbSb, 3, 3, 2, 2] + 
      ...
      DiagMark[MT, MChagl[Cha3]]*
       ((-(MT2*(g[CTSbL, Cha3, 2]*gC[CTSbL, Cha3, 2] + g[CTSbR, Cha3, 2]*
              gC[CTSbR, Cha3, 2])) - MT*(g[CTSbR, Cha3, 2]*gC[CTSbL, Cha3, 
              2] + g[CTSbL, Cha3, 2]*gC[CTSbR, Cha3, 2])*MChagl[Cha3])/8 + 
      ...
      (-(DiagMark[MT, MChagl[Cha3]]*(g[CTSbL, Cha3, 2]*gC[CTSbL, Cha3, 2] + 
         ...
         (MB2*(g[NBSbL, Neu3, 2]*gC[NBSbL, Neu3, 2] + g[NBSbR, Neu3, 2]*
             gC[NBSbR, Neu3, 2]) + MB*(g[NBSbR, Neu3, 2]*gC[NBSbL, Neu3, 2] + 
   ...
   dMSfsq1[0, 2, 2, 4, 3] -> 
    (dMSb1OS*((B0fin[0, 0, MHin^2]*DiagMark[MHin]*(g[hhSbSb, 2, 2, 2, 2] + 
       ...
       DiagMark[MT, MChagl[Cha3]]*
        ((-((MT2*(g[CTSbL, Cha3, 2]*gC[CTSbL, Cha3, 2] + g[CTSbR, Cha3, 2]*
                 gC[CTSbR, Cha3, 2]) + MT*(g[CTSbR, Cha3, 2]*gC[CTSbL, Cha3, 
                  2] + g[CTSbL, Cha3, 2]*gC[CTSbR, Cha3, 2])*MChagl[Cha3])*
       ...
       DiagMark[MB, MNeugl[Neu3]]*
        ((-((MB2*(g[NBSbL, Neu3, 2]*gC[NBSbL, Neu3, 2] + g[NBSbR, Neu3, 2]*
                 gC[NBSbR, Neu3, 2]) + MB*(g[NBSbR, Neu3, 2]*gC[NBSbL, Neu3, 
                  2] + g[NBSbL, Neu3, 2]*gC[NBSbR, Neu3, 2])*MNeugl[Neu3])*
