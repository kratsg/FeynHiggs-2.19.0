 ...
 {{dMSfsq1[-1, 2, 1, 3, 3] -> 
    ((DiagMark[MHin]*(g[hhStSt, 2, 2, 1, 2] + g[hhStSt, 3, 3, 1, 2] + 
      ...
      DiagMark[MB, MChagl[Cha3]]*
       ((-(MB2*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 1] + g[CBStR, Cha3, 2]*
              gC[CBStR, Cha3, 1])) - MB*(g[CBStR, Cha3, 2]*gC[CBStL, Cha3, 
              1] + g[CBStL, Cha3, 2]*gC[CBStR, Cha3, 1])*MChagl[Cha3])/8 + 
      ...
      (-(DiagMark[MB, MChagl[Cha3]]*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 1] + 
          ...
          SumOver[Cha3, 2]) - DiagMark[MT, MNeugl[Neu3]]*
         (MT2*(g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 1] + g[NTStR, Neu3, 2]*
             gC[NTStR, Neu3, 1]) + MT*(g[NTStR, Neu3, 2]*gC[NTStL, Neu3, 1] + 
            g[NTStL, Neu3, 2]*gC[NTStR, Neu3, 1])*MNeugl[Neu3])*
         SumOver[Neu3, 4])/8 + 
   ...
   dMSfsq1[0, 2, 1, 3, 3] -> 
    (dMSt1OS*((B0fin[0, 0, MHin^2]*DiagMark[MHin]*(g[hhStSt, 2, 2, 1, 2] + 
       ...
       DiagMark[MB, MChagl[Cha3]]*
        (-1/16*((MB2*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 1] + g[CBStR, Cha3, 
                2]*gC[CBStR, Cha3, 1]) + MB*(g[CBStR, Cha3, 2]*gC[CBStL, 
                Cha3, 1] + g[CBStL, Cha3, 2]*gC[CBStR, Cha3, 1])*
             MChagl[Cha3])*(Re[B0fin[MSf2[1, 3, 3], MB2, MChagl[Cha3]^2]] + 
            Re[B0fin[MSf2[2, 3, 3], MB2, MChagl[Cha3]^2]])) + 
         (g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 1] + g[CBStR, Cha3, 2]*
            gC[CBStR, Cha3, 1])*(-1/8*(B0fin[0, 0, MChagl[Cha3]^2]*
        ...
        (-1/16*((MT2*(g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 1] + g[NTStR, Neu3, 
                2]*gC[NTStR, Neu3, 1]) + MT*(g[NTStR, Neu3, 2]*gC[NTStL, 
                Neu3, 1] + g[NTStL, Neu3, 2]*gC[NTStR, Neu3, 1])*
             MNeugl[Neu3])*(Re[B0fin[MSf2[1, 3, 3], MT2, MNeugl[Neu3]^2]] + 
            Re[B0fin[MSf2[2, 3, 3], MT2, MNeugl[Neu3]^2]])) + 
         (g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 1] + g[NTStR, Neu3, 2]*
            gC[NTStR, Neu3, 1])*(-1/8*(B0fin[0, 0, MNeugl[Neu3]^2]*
    ...
    (dMSt1OS*((B0del[0, 0, MHin^2]*DiagMark[MHin]*(g[hhStSt, 2, 2, 1, 2] + 
       ...
       DiagMark[MB, MChagl[Cha3]]*
        (-1/16*((MB2*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 1] + g[CBStR, Cha3, 
         ...
         (g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 1] + g[CBStR, Cha3, 2]*
            gC[CBStR, Cha3, 1])*(-1/8*(B0del[0, 0, MChagl[Cha3]^2]*
        ...
        (-1/16*((MT2*(g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 1] + g[NTStR, Neu3, 
         ...
         (g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 1] + g[NTStR, Neu3, 2]*
            gC[NTStR, Neu3, 1])*(-1/8*(B0del[0, 0, MNeugl[Neu3]^2]*
