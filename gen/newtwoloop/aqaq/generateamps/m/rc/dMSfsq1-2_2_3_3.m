 ...
 {{dMSfsq1[-1, 2, 2, 3, 3] -> 
    ((DiagMark[MHin]*(g[hhStSt, 2, 2, 2, 2] + g[hhStSt, 3, 3, 2, 2] + 
      ...
      DiagMark[MB, MChagl[Cha3]]*
       ((-(MB2*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 2] + g[CBStR, Cha3, 2]*
              gC[CBStR, Cha3, 2])) - MB*(g[CBStR, Cha3, 2]*gC[CBStL, Cha3, 
              2] + g[CBStL, Cha3, 2]*gC[CBStR, Cha3, 2])*MChagl[Cha3])/8 + 
      ...
      (-(DiagMark[MB, MChagl[Cha3]]*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 2] + 
         ...
         (MT2*(g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 2] + g[NTStR, Neu3, 2]*
             gC[NTStR, Neu3, 2]) + MT*(g[NTStR, Neu3, 2]*gC[NTStL, Neu3, 2] + 
            g[NTStL, Neu3, 2]*gC[NTStR, Neu3, 2])*MNeugl[Neu3])*
         SumOver[Neu3, 4])/8 + 
   ...
   dMSfsq1[0, 2, 2, 3, 3] -> 
    (dMSt1OS*((B0fin[0, 0, MHin^2]*DiagMark[MHin]*(g[hhStSt, 2, 2, 2, 2] + 
       ...
       DiagMark[MB, MChagl[Cha3]]*
        ((-((MB2*(g[CBStL, Cha3, 2]*gC[CBStL, Cha3, 2] + g[CBStR, Cha3, 2]*
                 gC[CBStR, Cha3, 2]) + MB*(g[CBStR, Cha3, 2]*gC[CBStL, Cha3, 
                  2] + g[CBStL, Cha3, 2]*gC[CBStR, Cha3, 2])*MChagl[Cha3])*
       ...
       DiagMark[MT, MNeugl[Neu3]]*
        ((-((MT2*(g[NTStL, Neu3, 2]*gC[NTStL, Neu3, 2] + g[NTStR, Neu3, 2]*
                 gC[NTStR, Neu3, 2]) + MT*(g[NTStR, Neu3, 2]*gC[NTStL, Neu3, 
                  2] + g[NTStL, Neu3, 2]*gC[NTStR, Neu3, 2])*MNeugl[Neu3])*
