...
htInsert[c_] :=
Block[ {cy, mtmw},
  cy = mtmw^2 Coefficient[c MW^2/MT^2 /. MB2 -> 0 /. MB -> 0, MW, 0];
  cy += mtmw Coefficient[(c - cy /. mtmw -> MT/MW) MW/MT /. MB2 -> 0 /. MB -> 0, MW, 0];
  cy += c - cy /. mtmw -> MT/MW;
...
hbInsert[c_] :=
Block[ {cy, mbmw},
  cy = mbmw^2 Coefficient[c MW^2/MB^2 /. ht -> 0 /. MT -> 0, MW, 0];
  cy += mtmbmw2 Coefficient[(c - cy /. mbmw -> MB/MW) MW^2/MT/MB /. ht -> 0, MW, 0];
  cy += mbmw Coefficient[(c - cy /. mbmw -> MB/MW /. mtmbmw2 -> MT MB/MW^2) MW/MB /. ht -> 0 /. MT -> 0, MW, 0];
...
Modify[expr_, xtra___] := expr /.
  ...
  { xtra,
    ...
    dZbarHiggs1[i:5|6, j:5|6] :> dZCHiggs1[i, j],
    dZHiggs1[i:5|6, j:5|6] :> dZCHiggs1[i, j],
    dZHiggs1[i_, j_] :> dZNHiggs1[i, j],
    dMHiggs1[i:5|6, j:5|6] :> dMCHiggs1[i, j],
    dMHiggs1[i_, j_] :> dMNHiggs1[i, j],
    MG0 | MGp | Mh0tree -> M0,
