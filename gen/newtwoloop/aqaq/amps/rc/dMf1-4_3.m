{dMf1[4, 3] -> RC[-1, dMf1[-1, 4, 3]] + RC[0, dMf1[0, 4, 3]] + 
 ...
 {{dMf1[-1, 4, 3] -> 
    ...
    -((dMB1OS*(-(DiagMark[0, MT]*(MB*g[HpTBR, 2]*gC[HpTBR, 2] + 
            MT*(g[HpTBR, 2]*gC[HpTBL, 2] + g[HpTBL, 2]*gC[HpTBR, 2]))*
           Re[B0fin[MB2, 0, MT2]])/32 + 
        MB*(DiagMark[0, MB]*((B0fin[0, 0, MB2]*(g[hBBL, 1]*g[hBBR, 1] + 
          ...
          DiagMark[0, MT]*(-(g[HpTBL, 2]*gC[HpTBL, 2]*Re[B0fin[MB2, 0, MT2]])/
             32 + ((g[HpTBL, 2]*gC[HpTBL, 2] + g[HpTBR, 2]*gC[HpTBR, 2])*
              (MT2*B0fin[0, 0, MT2] + (MB2 - MT2)*Re[B0fin[MB2, 0, MT2]]))/
             (64*MB2)) + DiagMark[MB, MHin]*
           (-((g[hBBL, 2]^2 + g[hBBL, 3]^2 + g[hBBR, 2]^2 + g[hBBR, 3]^2)*Re[
                B0fin[MB2, MB2, MHin^2]])/32 + 
        ...
        DiagMark[MHin, MT]*(-(MT*(g[HpTBR, 1]*gC[HpTBL, 1] + g[HpTBL, 1]*gC[
                HpTBR, 1])*Re[B0fin[MB2, MHin^2, MT2]])/32 + 
        ...
        (DiagMark[MChagl[Cha3], MSf[Sfe3, 3, 3]]*
          ...
          DiagMark[MNeugl[Neu3], MSf[Sfe3, 4, 3]]*
           (-((MB*(g[NBSbL, Neu3, Sfe3]*gC[NBSbL, Neu3, Sfe3] + 
               ...
               Re[B0fin[MB2, MNeugl[Neu3]^2, MSf2[Sfe3, 4, 3]]])/32 - 
    ...
    -((dMB1OS*(-(DiagMark[0, MT]*(MB*g[HpTBR, 2]*gC[HpTBR, 2] + 
        ...
        (DiagMark[MChagl[Cha3], MSf[Sfe3, 3, 3]]*
           (-((MB*(g[CBStL, Cha3, Sfe3]*gC[CBStL, Cha3, Sfe3] + 
                ...
                (g[CBStR, Cha3, Sfe3]*gC[CBStL, Cha3, Sfe3] + 
                  g[CBStL, Cha3, Sfe3]*gC[CBStR, Cha3, Sfe3])*MChagl[Cha3])*
               Re[B0del[MB2, MChagl[Cha3]^2, MSf2[Sfe3, 3, 3]]])/32 - 
            (MB*(g[CBStL, Cha3, Sfe3]*gC[CBStL, Cha3, Sfe3] + g[CBStR, Cha3, 
          ...
          DiagMark[MNeugl[Neu3], MSf[Sfe3, 4, 3]]*
           (-((MB*(g[NBSbL, Neu3, Sfe3]*gC[NBSbL, Neu3, Sfe3] + 
                ...
                (g[NBSbR, Neu3, Sfe3]*gC[NBSbL, Neu3, Sfe3] + 
                  g[NBSbL, Neu3, Sfe3]*gC[NBSbR, Neu3, Sfe3])*MNeugl[Neu3])*
               Re[B0del[MB2, MNeugl[Neu3]^2, MSf2[Sfe3, 4, 3]]])/32 - 
            (MB*(g[NBSbL, Neu3, Sfe3]*gC[NBSbL, Neu3, Sfe3] + g[NBSbR, Neu3, 
