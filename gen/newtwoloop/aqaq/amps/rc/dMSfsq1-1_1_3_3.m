 ...
 {{dMSfsq1[-1, 1, 1, 3, 3] -> 
    ((DiagMark[MHin]*(g[hhStSt, 2, 2, 1, 1] + g[hhStSt, 3, 3, 1, 1] + 
      ...
      DiagMark[MB, MChagl[Cha3]]*
       ((-(g[CBStR, Cha3, 1]*(MB2*gC[CBStR, Cha3, 1] + MB*gC[CBStL, Cha3, 1]*
              MChagl[Cha3])) - g[CBStL, Cha3, 1]*(MB2*gC[CBStL, Cha3, 1] + 
      ...
      (-(DiagMark[MB, MChagl[Cha3]]*(g[CBStL, Cha3, 1]*gC[CBStL, Cha3, 1] + 
         ...
         (g[NTStR, Neu3, 1]*(MT2*gC[NTStR, Neu3, 1] + MT*gC[NTStL, Neu3, 1]*
             MNeugl[Neu3]) + g[NTStL, Neu3, 1]*(MT2*gC[NTStL, Neu3, 1] + 
   ...
   dMSfsq1[0, 1, 1, 3, 3] -> 
    (dMSt1OS*((B0fin[0, 0, MHin^2]*DiagMark[MHin]*(g[hhStSt, 2, 2, 1, 1] + 
       ...
       DiagMark[MB, MChagl[Cha3]]*
        ((-((g[CBStR, Cha3, 1]*(MB2*gC[CBStR, Cha3, 1] + MB*gC[CBStL, Cha3, 
                  1]*MChagl[Cha3]) + g[CBStL, Cha3, 1]*(MB2*gC[CBStL, Cha3, 
                  1] + MB*gC[CBStR, Cha3, 1]*MChagl[Cha3]))*
       ...
       DiagMark[MT, MNeugl[Neu3]]*
        ((-((g[NTStR, Neu3, 1]*(MT2*gC[NTStR, Neu3, 1] + MT*gC[NTStL, Neu3, 
                  1]*MNeugl[Neu3]) + g[NTStL, Neu3, 1]*(MT2*gC[NTStL, Neu3, 
                  1] + MT*gC[NTStR, Neu3, 1]*MNeugl[Neu3]))*
