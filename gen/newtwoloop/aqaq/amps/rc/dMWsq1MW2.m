    ...
    (Nc*((MW2*cTAG[Yuk]^2*DiagMark[MT, MB]*(-(CB2*hb^2*B0del[0, 0, MB2]) - 
         ...
         (B0del[0, 0, MSf2[Sfe3, 4, 3]]*DiagMark[MSf[Sfe3, 4, 3]]*
           ...
           (B0del[0, 0, MSf2[Sfe3, 3, 3]]*DiagMark[MSf[Sfe3, 3, 3]]*
             MSf2[Sfe3, 3, 3] - (DiagMark[MSf[Sfe3, 3, 3], MSf[Sfe4, 4, 3]]*
              (3*(MSf2[Sfe3, 3, 3] + MSf2[Sfe4, 4, 3]) + 
               (9*MSf2[Sfe3, 3, 3] + 3*MSf2[Sfe4, 4, 3])*Re[B0del[0, 
                  MSf2[Sfe3, 3, 3], MSf2[Sfe4, 4, 3]]] + MSf2[Sfe4, 4, 3]*
                (6*B0del[0, 0, MSf2[Sfe4, 4, 3]] + 2*B0fin[0, 0, MSf2[Sfe4, 
                    4, 3]] + 4*Re[B0fin[0, 0, MSf2[Sfe4, 4, 3]]]) + 6*
                MSf2[Sfe3, 3, 3]*Re[B0fin[0, MSf2[Sfe3, 3, 3], MSf2[Sfe4, 4, 
                   3]]] + (6*MSf2[Sfe3, 3, 3]*MSf2[Sfe4, 4, 3] - 
                 3*(MSf2[Sfe3, 3, 3]^2 + MSf2[Sfe4, 4, 3]^2))*
                Re[DB0del[0, MSf2[Sfe3, 3, 3], MSf2[Sfe4, 4, 3]]])*
              SumOver[Sfe4, 2]*UCSf[Sfe4, 1, 4, 3])/9)))/(Pi*SW2)))/(8*MW2)}}}
